...
df = pd.read_csv('~/Documents/scripts/dpd/outpute4.txt',header=None,sep='\t',names=['A','B','d'])
df2 = pd.read_csv('~/Documents/scripts/dpd/outpute5.txt',header=None,sep='\t',names=['A','B','d'])
...
plt.show()
### probably worth producing a heatmap, even if the equally spaced thing doesn'twork as expected
